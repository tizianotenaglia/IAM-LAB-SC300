...
with the App Registration's client secret)[click here to check the mistake](./6.1%20App%20registration/App%20registration.md#tripped-twice). Entra ID handles the authentication behind the scenes,
