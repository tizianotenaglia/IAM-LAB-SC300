...
with the App Registration's client secret)[click here to check the mistake](App%20registration.md#tripped-twice). Entra ID handles the authentication behind the scenes,
